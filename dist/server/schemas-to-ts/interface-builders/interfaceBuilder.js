...
class InterfaceBuilder {
    ...
    `);
        if (extensionFolderModelsPath && fileHelpers_1.FileHelpers.folderExists(`${extensionFolderModelsPath}/users-permissions/content-types/user`)) {
            this.addCommonSchema(commonSchemas, commonFolderModelsPath, 'User', `import {FullUser, FullUser_Plain, FullUser_NoRelations} from "../../extensions/users-permissions/content-types/user/FullUser";
